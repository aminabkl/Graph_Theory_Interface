...
def dfsAlgo():
    if request.method == 'POST':
        ...
        return render_template('Dfs.html', dfs_result=dfs_result)
    else:
...
def bfsAlgo():
    if request.method == 'POST':
        ...
        return render_template('Bfs.html', bfs_result=bfs_result)
    else:
...
def primAlgo():
    if request.method == 'POST':
        ...
        return render_template('Prim.html', prim_result=prim_result)
    else:
